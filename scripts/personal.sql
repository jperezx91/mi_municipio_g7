...
', 3, CAST('2018-08-19T00:00:00.000' AS DateTime));
...
Escuelas', 2, CAST('2016-08-19T00:00:00.000' AS DateTime));
INSERT INTO personal (legajo, nombre, apellido, documento, password, sector, categoria, fechaIngreso) VALUES (3, 'JOSE                 ', 'OLIVERA', 'DNI30667193', 'password', 'Museos', 7, CAST('2015-02-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2020-07-19T00:00:00.000' AS DateTime));
INSERT INTO personal (legajo, nombre, apellido, documento, password, sector, categoria, fechaIngreso) VALUES (5, 'PABLO                 ', 'BLANCO', 'DNI30702760', 'password', 'Bacheo y Demarcacio', 6, CAST('2019-07-19T00:00:00.000' AS DateTime));
INSERT INTO personal (legajo, nombre, apellido, documento, password, sector, categoria, fechaIngreso) VALUES (6, 'PABLO                   ', 'CRUZ', 'DNI30724804', 'password', 'Plazas y Parques', 4, CAST('2020-12-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2019-05-19T00:00:00.000' AS DateTime));
...
', 4, CAST('2019-11-19T00:00:00.000' AS DateTime));
...
Seguridad
', 7, CAST('2020-05-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2017-10-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2018-11-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2016-09-19T00:00:00.000' AS DateTime));
...
Seguridad
', 1, CAST('2017-12-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2018-09-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2015-11-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2017-03-19T00:00:00.000' AS DateTime));
...
Edificios Publicos y Oficinas
', 2, CAST('2019-04-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2014-11-19T00:00:00.000' AS DateTime));
...
', 4, CAST('2021-06-19T00:00:00.000' AS DateTime));
...
', 2, CAST('2014-11-19T00:00:00.000' AS DateTime));
...
', 4, CAST('2015-02-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2015-05-19T00:00:00.000' AS DateTime));
...
', 1, CAST('2021-10-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2020-08-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2019-04-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2018-09-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2015-07-19T00:00:00.000' AS DateTime));
...
', 1, CAST('2019-09-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2021-09-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2014-08-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2014-06-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2014-07-19T00:00:00.000' AS DateTime));
...
', 2, CAST('2018-11-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2017-05-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2017-01-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2021-03-19T00:00:00.000' AS DateTime));
...
', 2, CAST('2019-10-19T00:00:00.000' AS DateTime));
...
', 1, CAST('2015-09-19T00:00:00.000' AS DateTime));
...
', 3, CAST('2016-10-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2015-05-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2019-05-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2019-09-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2015-11-19T00:00:00.000' AS DateTime));
...
Seguridad
', 2, CAST('2015-06-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2015-10-19T00:00:00.000' AS DateTime));
...
Seguridad
', 3, CAST('2021-05-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2014-09-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2020-05-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2019-08-19T00:00:00.000' AS DateTime));
...
Seguridad
', 4, CAST('2014-05-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2017-01-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2022-01-19T00:00:00.000' AS DateTime));
...
Seguridad
', 3, CAST('2016-08-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2018-07-19T00:00:00.000' AS DateTime));
...
', 1, CAST('2015-07-19T00:00:00.000' AS DateTime));
...
', 2, CAST('2020-08-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2020-01-19T00:00:00.000' AS DateTime));
...
', 9, CAST('2020-04-19T00:00:00.000' AS DateTime));
...
', 2, CAST('2021-12-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2015-06-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2019-12-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2017-09-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2015-07-19T00:00:00.000' AS DateTime));
...
', 6, CAST('2020-12-19T00:00:00.000' AS DateTime));
...
', 1, CAST('2017-10-19T00:00:00.000' AS DateTime));
...
', 7, CAST('2015-05-19T00:00:00.000' AS DateTime));
...
Edificios Publicos y Oficinas
', 3, CAST('2016-05-19T00:00:00.000' AS DateTime));
INSERT INTO personal (legajo, nombre, apellido, documento, password, sector, categoria, fechaIngreso) VALUES (69, 'SEBASTIAN             ', 'OCAMPO', 'DNI31895478', 'password', 'Escuelas', 2, CAST('2019-05-19T00:00:00.000' AS DateTime));
...
', 4, CAST('2018-05-19T00:00:00.000' AS DateTime));
...
', 2, CAST('2018-08-19T00:00:00.000' AS DateTime));
...
', 3, CAST('2014-11-19T00:00:00.000' AS DateTime));
...
', 4, CAST('2017-09-19T00:00:00.000' AS DateTime));
...
', 8, CAST('2014-03-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2014-02-19T00:00:00.000' AS DateTime));
...
', 4, CAST('2018-08-19T00:00:00.000' AS DateTime));
...
', 5, CAST('2020-05-19T00:00:00.000' AS DateTime));