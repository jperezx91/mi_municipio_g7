...
const PublicacionComponente = ({ title, desc, imgUrl, goToPublicacion }: { title: string; desc: string, imgUrl:any, goToPublicacion: any}) => {
    return (
        <Pressable onPress={goToPublicacion} style={{ margin: 4, borderWidth: 1, borderColor: '#DDE1E6', marginTop: 8, backgroundColor: 'white', borderRadius:25}}>
            <Image style={{height: 190, width: 175, borderTopLeftRadius:25, borderTopRightRadius:25}} source={imgUrl} />
