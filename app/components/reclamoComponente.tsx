...
const ReclamoComponente = ({ numero_reclamo="", categoria, estado, goToPublicacion }: { numero_reclamo: string; categoria: string, estado: string, goToPublicacion: any}) => {
    return (
        <Pressable onPress={goToPublicacion} style={{ margin: 4, borderWidth: 1, borderColor: '#DDE1E6', marginTop: 8, backgroundColor: 'white', borderRadius:25}}>
            <View style={{display: 'flex',  padding:15, maxHeight:120}}>
                ...
                <Text style={{textAlign: 'left', fontSize: 18, fontFamily:'outfit-bold', alignSelf: 'auto', marginTop: 8}}>Reclamo #{numero_reclamo}</Text>
